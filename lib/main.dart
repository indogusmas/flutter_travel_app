...
import 'package:fluttertravelapp/DetailPage.dart';
              ...
              child: Center(
                child: TextField(
                  decoration: InputDecoration(
                    ...
                    hintText: 'What Would you like to discocer?',
                    hintStyle: TextStyle(
                      fontFamily: 'Opensans',
                      fontSize: 15.0,
                      color: Colors.grey.withOpacity(0.7)),
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  _buildCard(
                      'Tebing Breksi, Yogya','4.5' , 'assets/breksi.jpg'),
                  _buildCard(
                      'Pamir Mountains, China', '4.1', 'assets/mountain.jpg'),
                  _buildCard(
                      'Kathmandu City Nepal', '4.2', 'assets/kathmandu.jpg')
                ],
              ),
            ),
          )
...
_buildCard(String title, String rating, String imPath) {
  return Padding(
